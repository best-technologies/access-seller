        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <section className="mb-8">
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              books, e-books, and related products from our platform.
            </p>
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-brand-500 pl-4">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                  ...
                  <li>Email address</li>
                  <li>Phone number</li>
                  <li>Delivery address (including state and city in Nigeria)</li>
              ...
              <div className="border-l-4 border-gray-300 pl-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  If you join our affiliate programme, we collect additional
                  information such as your referral links, commission history,
                  and payout details to manage your affiliate account.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              <li>To process and fulfil your book orders, including shipping physical books and delivering e-books</li>
              <li>To create and manage your user account</li>
              <li>To communicate with you about your orders, account, and customer service enquiries</li>
              <li>To send promotional emails about new arrivals, deals, and special offers (you may opt out at any time)</li>
              <li>To manage our affiliate and referral programme, including tracking commissions and processing payouts</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              <li>
                ...
                shipping and delivery, email services, and website analytics.
              </li>
              <li>
                ...
                property, or safety of Access&Sellr, our users, or others.
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              include encrypted data transmission, secure servers, and access
              controls.
            </p>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              request deletion of your account, we will remove your data within
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              ...
              <li>
                <strong>Data Portability:</strong> Where applicable, you can
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              social media platforms and payment providers. We are not
