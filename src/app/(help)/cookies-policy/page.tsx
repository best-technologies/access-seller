        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <section className="mb-8">
            <p className="text-gray-700 leading-relaxed mb-4">
              This Cookie Policy explains how Access&Sellr (&quot;we,&quot;
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Cookies set by the website owner (in this case, Access&Sellr) are
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              or &quot;strictly necessary&quot; cookies. Other cookies enable us
            ...
            <div className="space-y-6">
              ...
              <div className="border-l-4 border-brand-500 pl-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  features, such as access to secure areas. These cookies cannot
              ...
              <div className="border-l-4 border-gray-300 pl-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  services may not function properly. These cookies allow us to
              ...
              <div className="border-l-4 border-gray-300 pl-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  other sites. They work by uniquely identifying your browser
                  and device. If you do not allow these cookies, you will
              ...
              <div className="border-l-4 border-gray-300 pl-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  These cookies are set by a range of social media services that
                  we have added to the site to enable you to share our content
                  with your friends and networks. They are capable of tracking
                  your browser across other sites and building up a profile of
                  your interests. This may impact the content and messages you
                  see on other websites you visit. If you do not allow these
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              In addition, most web browsers allow some control of most cookies
              through browser settings. To find out more about cookies,
            ...
            <p className="text-gray-700 leading-relaxed">
              Please note that if you choose to block cookies, you may not be
              able to access all or parts of our site, and certain features may
              not work properly.
            </p>
          </section>
